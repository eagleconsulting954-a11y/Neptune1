...
export const metadata: Metadata = {
  ...
  description: "A premium vessel command, fleet trends, critical alerts, decision recommendations, maritime intelligence, CRM, analytics, enforced 14-day trial, platform monitoring, and secure account recovery system."
};
