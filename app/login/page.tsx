...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ reset?: string; verified?: string }> }) {
  ...
  const verified = params.verified === "success";
  ...
  return (
    <main className="auth-page">
      <section className="auth-card glass premium">
        ...
        <p className="muted">Sign in with your verified organization identity to access vessel, fleet, safety, offline, and operational records.</p>
        ...
        {verified && <div className="form-message success login-reset-success">Email verified. You can now sign in to Neptune.</div>}
        <AuthForm mode="login" />
