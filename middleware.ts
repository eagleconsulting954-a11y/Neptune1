...
export function middleware(request: NextRequest) {
  ...
  const tenantRoute = pathname.startsWith("/dashboard") || pathname.startsWith("/admin") || pathname.startsWith("/security-center") || pathname.startsWith("/passkeys");
...
export const config = { matcher: ["/dashboard/:path*", "/admin/:path*", "/platform-admin/:path*", "/security-center/:path*", "/passkeys/:path*"] };
